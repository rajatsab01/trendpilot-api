...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { path: "/saved", icon: "bookmark", label: t.saved || "Saved", testId: "nav-saved" },
    { path: "/community", icon: "group", label: t.community || "Community", testId: "nav-community", badge: unreadCount },
